export function InstallationContent({ shop }: { shop: string }) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Step 1 — Enable the App Embed</h3>
      ...
      <div className="border-t border-slate-200 pt-8">
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Step 2 — Full Reviews Widget (Product Page)</h3>
        <p className="mb-3 text-sm text-slate-500">
          The main review section — shows average rating, star breakdown bars, review cards, and the
          "Write a Review" form. Add the <strong className="text-slate-900">Rivu Reviews</strong> block
      ...
      <div className="border-t border-slate-200 pt-8">
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Step 3 — Star Badge near Product Title</h3>
        <p className="mb-3 text-sm text-slate-500">
          ...
          <strong className="text-slate-900">Rivu Rating Badge</strong> block near your product title in
          the theme editor. Star size and text are customizable from{" "}
          <a href={`/dashboard/widget-settings?shop=${shop}`} className="text-slate-900 underline">
            Widget Settings
          </a>.
        </p>
        <a
      ...
      <div className="border-t border-slate-200 pt-8">
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Step 4 — Stars on Collection / Product Cards</h3>
        <p className="mb-3 text-sm text-slate-500">
          ...
          <strong className="text-slate-900">Rivu Rating Badge</strong> block inside your product card
      ...
      <div className="border-t border-slate-200 pt-8">
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Manual install — Full Reviews Widget (advanced)</h3>
        <p className="mb-3 text-sm text-slate-500">
          For themes that don&apos;t support app blocks, paste this into your product template
          Liquid file:
        </p>
        <pre className="overflow-x-auto rounded-md bg-black/40 p-4 text-xs text-slate-600">
...
<script src="https://YOUR-APP-DOMAIN.vercel.app/widget.js" async></script>`}
      ...
      <div className="border-t border-slate-200 pt-8">
        <h3 className="mb-2 text-sm font-semibold text-slate-900">Manual install — Rating Badge on Product Cards (advanced)</h3>
        <p className="mb-3 text-sm text-slate-500">
          To add the compact star badge inside product card snippets (e.g.{" "}
          <code className="text-emerald-700">card-product.liquid</code>) manually:
        </p>
        <pre className="overflow-x-auto rounded-md bg-black/40 p-4 text-xs text-slate-600">
